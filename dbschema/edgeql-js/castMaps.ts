...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$Unit ? _default.$Unit : 
  T extends _default.$Text ? _default.$Text : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _fts.$ElasticLanguage ?
    ...
    never
  :
  A extends _default.$Unit ?
    B extends _default.$Unit ?
    B
    :
    never
  :
  A extends _default.$Text ?
    B extends _default.$Text ?
    B
    :
    never
  :
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::Unit") {
    if(b.__name__ === "default::Unit") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::Text") {
    if(b.__name__ === "default::Text") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
